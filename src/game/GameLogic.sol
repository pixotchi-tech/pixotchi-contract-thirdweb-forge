...
//    function mint(uint256 _strain) external  {
//        mintTo(_strain, msg.sender);
//    }
//
//
//    function mintTo(uint256 _strain, address _to) public nonReentrant {
//        require(_s().mintIsActive, "Mint is closed");
//        require(_s().strainIsActive[_strain], "Strain is not active");
//        require(_s().strainTotalMinted[_strain] < _s().strainMaxSupply[_strain], "Strain supply exceeded");
//
//
//
//        tokenBurnAndRedistribute(msg.sender, _s().mintPriceByStrain[_strain]);
//
...
//
//        IGameLogic.Plant memory _plant = IGameLogic.Plant({
//            name: "",
...
//        uint256 _quantity = 1;
//        _mint(_to, _quantity);
//        emit Mint(_to, _strain, _tokenId);
//
//        _s().strainTotalMinted[_strain]++;
//        //_s()._tokenIds++;
//    }
