...
//    }
    ...
    function mintTo(uint256 strain, address to) public nonReentrant {
        ...
        _tokenBurnAndRedistribute(msg.sender, _s().mintPriceByStrain[strain]);
...
//    }
    ...
    function burn(uint256 tokenId) external guard {
        //require(_s().approvedToBurn[tokenId], "Not approved to burn");
        //_s().approvedToBurn[msg.sender] = false;
        super._burn(tokenId);
        //_s().burnedPlants[tokenId] = true; // Mark the plant ID as burned
    }
